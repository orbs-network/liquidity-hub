...
import {Uni2Lens, IERC20Metadata} from "src/Uni2Lens.sol";

contract Uni2LensTest is BaseTest {
    Uni2Lens public uut;

    function setUp() public override {
        // super.setUp();
        _chainBNB();
        (address uni2Lens,) = new DeployLens().run();
        uut = Uni2Lens(uni2Lens);
    }

    function test_observe() public {
        address token = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; // cake on bnb
        Uni2Lens.Observation memory result = uut.observe(token);
